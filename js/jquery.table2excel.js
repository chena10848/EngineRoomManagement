...
(function ( $, window, document, undefined ) {
    ...
    defaults = {
        ...
        exclude_links: true,
        exclude_inputs: true,
        style: false, // set to true if you want background colors and font colors and border preserved
        timestamp: ''
    };
    ...
    Plugin.prototype = {
        init: function () {
            ...
            e.tableToExcel(e.tableRows, e.settings.name, e.settings.sheetName, e.settings.timestamp);
        },

        tableToExcel: function (table, name, sheetName, timestamp) {
            ...
            fullTemplate += `<!--<製表時間>${timestamp}</製表時間>-->`;
