...
<head >
    ...
    <!-- 銷售排序css -->
    <link href='css/userpasswordset/userpasswordset.css?v=<?php echo microtime();?>' rel='stylesheet'>
    <!-- 銷售排序js -->
    <script src='js/userpasswordset/userpasswordset.js?v=<?php echo microtime();?>'></script>
</head>
...
<body>
    ...
    <div class="ch-container" >
        <div class="row">
            ...
            <?php include("html/userpasswordset/userpasswordset.html");?>
